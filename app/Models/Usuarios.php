...
class Usuarios extends DBAbstractModel
{
    ...
    public function registrar($nombre, $apellidos, $password, $email, $categoria_profesional, $resumen_perfil, $token, $fecha_creacion_token)
    {
        ...
        $this->query = "INSERT INTO usuarios (nombre, apellidos, password, email, categorias_profesional, resumen_perfil, token, fecha_creacion_token) VALUES (:nombre, :apellidos, :password, :email, :categoria_profesional, :resumen_perfil, :token, :fecha_creacion_token)";
        $this->parametros['nombre'] = $nombre;
...
{   
    $this->query = "UPDATE usuarios SET nombre = :nombre, apellidos = :apellidos, categorias_profesional = :categoria_profesional, resumen_perfil = :resumen_perfil, foto = :foto WHERE id = :id";
